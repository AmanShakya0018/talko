        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-sm md:text-[16px] text-zinc-500 dark:text-zinc-400 mb-8">
              Talko leverages cutting-edge technologies to deliver a seamless, reliable, and secure communication
              ...
              <div className="relative bg-white dark:bg-black/95 p-6 rounded-xl shadow-lg border border-neutral-200 dark:border-neutral-800 z-10">
                <div className="space-y-4">
                  ...
                  <div className="bg-neutral-50 dark:bg-black p-4 rounded-md font-mono text-sm text-neutral-800 dark:text-neutral-200">
                    <div className="text-green-600 dark:text-green-400">{`// Talko's real-time messaging`}</div>
                    <div className="mt-2">
                    ...
                    <div className="mt-1">
                      ...
                      <span className="text-green-600 dark:text-green-400">&apos;https://talko-server.render.com&apos;</span>);
                    </div>
                    <div className="mt-3">
