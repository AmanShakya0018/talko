      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            ...
            />
            <span className="text-green-300 text-xs lg:text-[15px]">Reimagine Communication</span>
          </motion.div>

          <motion.h2
            className="text-5xl text-zinc-100 md:text-6xl lg:text-7xl font-bold leading-tight mb-8"
            initial={{ opacity: 0 }}
          ...
          <motion.p
            className="text-[15px] md:text-lg lg:text-xl text-zinc-300 max-w-3xl mx-auto"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            {/* Card */}
            <div className="relative h-full bg-gradient-to-b from-zinc-800/80 to-zinc-900/80 backdrop-blur-xl border border-zinc-700/50 rounded-3xl p-1 overflow-hidden shadow-xl">
              ...
              <div className="relative h-full rounded-[calc(1.5rem-4px)] p-8 overflow-hidden">
                ...
                <div className="flex flex-col h-full">
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-full px-3 py-1 text-xs font-medium text-zinc-400">
                      Real-time
                    </div>
                  </div>
                  ...
                  <div className="mt-auto">
                    <button className="flex items-center gap-2 text-green-400 font-medium group/btn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                <div className="inline-block mb-4 px-4 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                  <span className="text-green-400 font-medium">✨ Seamless Experience</span>
                </div>
              ...
              <div className="relative h-96 lg:h-auto bg-gradient-to-br from-green-900/20 to-teal-900/20">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full max-w-xs mx-auto">
                    ...
                    <div className="overflow-hidden rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl shadow-2xl">
                      <div className="realtive border-b border-white/10 bg-white/5 px-4 py-2 flex items-center">
                        <div className="absolute left-4 flex space-x-1">
                          <div className="h-2 w-2 rounded-full bg-red-500" />
                          <div className="h-2 w-2 rounded-full bg-yellow-500" />
                          <div className="h-2 w-2 rounded-full bg-green-500" />
                        </div>
                        <div className="mx-auto text-xs text-zinc-400">Talko Mobile</div>
                      </div>
                      <div className="p-3 h-72 flex flex-col">
                        ...
                        <div className="mt-3 flex items-center gap-2">
                          <div className="flex-1 rounded-full border border-zinc-800 bg-zinc-900 px-3 py-1.5 text-xs text-zinc-400">
                            Message...
                          </div>
